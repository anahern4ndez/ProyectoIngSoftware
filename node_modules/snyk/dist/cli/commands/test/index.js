...
function test(...args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const pipResults = results.find((res) => res.packageManager === 'pip');
        const pinningSupported = pipResults &&
            (yield feature_flags_1.isFeatureFlagSupportedForOrg('pythonPinningAdvice')).ok;
