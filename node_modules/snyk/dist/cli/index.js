...
const unsupported_option_combination_error_1 = require("../lib/errors/unsupported-option-combination-error");
    ...
    for (const path of args.options._) {
        if (typeof path === 'string' && detect_1.isPathToPackageFile(path)) {
            ...
            if (++count > 1 && args.options['project-name']) {
                throw new unsupported_option_combination_error_1.UnsupportedOptionCombinationError([
                    'multiple paths',
                    'project-name',
                ]);
            }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (runtime.isUsingNode6(process.versions.node)) {
            alerts.registerAlerts([
                {
                    msg: 'Node.js v6 has past End-of-Life; please upgrade your current Node.js version ' +
